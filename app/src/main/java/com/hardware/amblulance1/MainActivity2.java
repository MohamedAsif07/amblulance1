...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button2 = findViewById(R.id.Button2); // New button

        // Set OnClickListener to the new button
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Your onClick logic for the new button here
                // For example, you can open a new activity
                Intent intent = new Intent(MainActivity2.this, counter.class);
